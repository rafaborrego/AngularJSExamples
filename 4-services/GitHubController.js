...
(function() {
     ...
     * @param $log logs information on the console
     * @param GitHubService service for getting data from GitHub
     */
    var GitHubController = function($scope, $log, GitHubService) {
        ...
        $log.info('Loaded GitHubController');
    };
    ...
    app.controller("GitHubController", ['$scope', '$log', 'GitHubService', GitHubController]);
}());